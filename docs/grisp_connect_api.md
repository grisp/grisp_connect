...
| Key (required *) | Type | Value / Example | Description
| --- | --- | --- | ---
| `"version"` * | string | e.g. `"1.0.0"` | Protcolo version
| `"platform"` * | string | `"grisp2"` | The platform identifier of the device
...
| `"last_event"` | string | `"failed"`, `"canceled"` or `"done"` | When in state `"ready"`, this field inform about the last event of the previous software update
...
| -42302 | `"Validation, cancelation or reboot required"` | The current software requires either to be validated, rebooted or canceled
...
| Value | Description
| --- | ---
| `"ok"` | The update process was canceled successfuly
| `"manual_reboot"` | The update was canceld, but a manual reboot is required to finalise the cancelation
...
| `"canceled"` | The software update was canceled
